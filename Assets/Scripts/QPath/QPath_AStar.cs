...
namespace QPath
{
    public class QPath_AStar
    {
        ...
        IQPathTile startTile;
        IQPathTile endTile;
        CostEstimateDelegate costEstimateDelegateFunc;
        ...
        public void DoWork()
        {
            ...
            f_score[startTile] = costEstimateDelegateFunc(startTile, endTile);
            ...
            while (openSet.Count > 0)
            {
                ...
                foreach (IQPathTile edge_neighbour in current.GetNeighbours())
                {
                    ...
                    f_score[neighbour] = g_score[neighbour] + costEstimateDelegateFunc(neighbour, endTile);
